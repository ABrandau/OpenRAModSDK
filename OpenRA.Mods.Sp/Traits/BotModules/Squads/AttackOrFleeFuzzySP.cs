...
{
	sealed class AttackOrFleeFuzzySP
	{
		...
		public static readonly AttackOrFleeFuzzySP Default = new AttackOrFleeFuzzySP(null, null, null);
		public static readonly AttackOrFleeFuzzySP Rush = new AttackOrFleeFuzzySP(new[]
		{
			"if ((OwnHealth is Normal) " +
			"and ((EnemyHealth is NearDead) or (EnemyHealth is Injured) or (EnemyHealth is Normal)) " +
