...
{
	abstract class AirStateBaseSP : StateBaseSP
	{
		...
		protected static Actor FindDefenselessTarget(SquadSP owner)
		{
			Actor target = null;
		...
		protected static CPos? FindSafePlace(SquadSP owner, out Actor detectedEnemyTarget, bool needTarget)
		{
		...
		protected static bool NearToPosSafely(SquadSP owner, WPos loc)
		{
			Actor a;
			return NearToPosSafely(owner, loc, out a);
		}

		protected static bool NearToPosSafely(SquadSP owner, WPos loc, out Actor detectedEnemyTarget)
		{
			detectedEnemyTarget = null;
			var dangerRadius = owner.SquadManager.Info.DangerScanRadius;
	...
	class AirIdleStateSP : AirStateBaseSP, IState
	{
		...
		public void Tick(SquadSP owner)
		{
			...
			if (ShouldFlee(owner))
			{
				owner.FuzzyStateMachine.ChangeState(owner, new AirFleeStateSP(), true);
				return;
			}
			...
			owner.TargetActor = e;
			owner.FuzzyStateMachine.ChangeState(owner, new AirAttackStateSP(), true);
		}

		public void Deactivate(SquadSP owner) { }
	}

	class AirAttackStateSP : AirStateBaseSP, IState
	{
		public void Activate(SquadSP owner) { }
	...
	class AirFleeStateSP : AirStateBaseSP, IState
	{
		public void Activate(SquadSP owner) { }
		...
		public void Tick(SquadSP owner)
		{
			...
			owner.FuzzyStateMachine.ChangeState(owner, new AirIdleStateSP(), true);
		}
