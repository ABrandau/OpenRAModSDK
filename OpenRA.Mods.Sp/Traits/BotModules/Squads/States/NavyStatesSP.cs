...
{
	abstract class NavyStateBaseSP : StateBaseSP
	{
	...
	class NavyUnitsIdleStateSP : NavyStateBaseSP, IState
	{
		...
		public void Tick(SquadSP owner)
		{
			...
			if (AttackOrFleeFuzzySP.Default.CanAttack(owner.Units, enemyUnits))
			{
				...
				owner.FuzzyStateMachine.ChangeState(owner, new NavyUnitsAttackMoveStateSP(), true);
			}
			else
				owner.FuzzyStateMachine.ChangeState(owner, new NavyUnitsFleeStateSP(), true);
		}

		public void Deactivate(SquadSP owner) { }
	}

	class NavyUnitsAttackMoveStateSP : NavyStateBaseSP, IState
	{
		public void Activate(SquadSP owner) { }
		...
		public void Tick(SquadSP owner)
		{
			...
			else
			{
				...
				if (target != null)
				{
					...
					owner.FuzzyStateMachine.ChangeState(owner, new NavyUnitsAttackStateSP(), true);
				}
				else
	...
	class NavyUnitsAttackStateSP : NavyStateBaseSP, IState
	{
		public void Activate(SquadSP owner) { }
	...
	class NavyUnitsFleeStateSP : NavyStateBaseSP, IState
	{
		public void Activate(SquadSP owner) { }
		...
		public void Tick(SquadSP owner)
		{
			...
			owner.FuzzyStateMachine.ChangeState(owner, new NavyUnitsIdleStateSP(), true);
		}
