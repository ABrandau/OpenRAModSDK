...
{
	abstract class ProtectionStateBaseSP : GroundStateBaseSP
	{
	}

	class UnitsForProtectionIdleStateSP : ProtectionStateBaseSP, IState
	{
		...
		public void Tick(SquadSP owner)
		{
			...
			owner.FuzzyStateMachine.ChangeState(owner, new UnitsForProtectionAttackStateSP(), true);
		}

		public void Deactivate(SquadSP owner) { }
	}

	class UnitsForProtectionAttackStateSP : ProtectionStateBaseSP, IState
	{
		...
		public void Tick(SquadSP owner)
		{
			...
			if (!owner.IsTargetValid)
			{
				...
				if (owner.TargetActor == null)
				{
					owner.FuzzyStateMachine.ChangeState(owner, new UnitsForProtectionFleeStateSP(), true);
					return;
				}
			}
	...
	class UnitsForProtectionFleeStateSP : ProtectionStateBaseSP, IState
	{
		public void Activate(SquadSP owner) { }
		...
		public void Tick(SquadSP owner)
		{
			...
			owner.FuzzyStateMachine.ChangeState(owner, new UnitsForProtectionIdleStateSP(), true);
		}
